<?php
    ...
    while ($x<>$no) {
        ...
        $get_kelas = $siswa -> getKelas();
        $get_subkelas = $siswa -> getSubKelas();
        $kelassubkelas = "$get_kelas$get_subkelas";
        if ($kelassubkelas == ""){

            $showState = "Belum Dapat Kelas";
        } else {
            
            $showState = " Kelas $kelassubkelas";
        }
...
$(function() {
    ...
    var reloadTable = function(){
        ...
        $.ajax({
                type: "POST",
                url: "index.php?sajen=akademik_penempatan_siswa_atur_table",
    ...
    var inserttokelas = function(nis,kelas,subkelas){
        ...
        $.ajax({
            type: "POST",
            url: "index.php?sajen=akademik_penempatan_siswa_atur_insert",
