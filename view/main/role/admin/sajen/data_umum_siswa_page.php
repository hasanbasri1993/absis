...
$sql_all = "SELECT * FROM data_siswa WHERE nama LIKE '%$query%' OR nis LIKE '%$query%'";
...
$(document).ready(function(){
	...
	var search_table_page = function(query, page) {
		...
		$.ajax({
			...
			type: "POST",
			url: "?sajen=data_umum_siswa_search_page",
	...
	$(".halaman").on("click", function(){
		...
		if (page == "terakhir"){
			...
			$.ajax({
				...
				type: "POST",
				url: "?sajen=data_umum_siswa_search_page_terakhir",
				cache: false,
				success: function(html) {
