...
<div class="row">
  	<div style="float:left;padding-left:2%;position:fixed" class="col-md-3">
  		<br />
  		<h4 class="bolded">Cetak Dokumen</h4>
  		<form role="form" target="preview">
	  		...
	  		<table style="width:100%">
	  			<tr>
	  				...
	  				<td colspan="2">
	  					<select name="tipe" class="form-control select-tipe" id="select_tipe" onchange>
							...
							<option value="ledger" <?php echo $f;?>>Ledger Wali Kelas</option>
						</select>
					</td>
					<td>
					</td>
	  			...
	  			<tr hidden id="input_jenis">
	  				<td>Jenis</td>
	  				<td colspan="2">
	  					<select name="jenis" class="form-control select-jenis" id="select_jenis"> 
	  						<option>Jenis</option>
							<option value="uts&semester=1">UTS</option>
							<option value="uas&semester=1">UAS</option>
							<option value="uas_x&semester=1">Rapor UAS</option>
						</select>
					</td>
	  			</tr>	  			
	  			<tr>
