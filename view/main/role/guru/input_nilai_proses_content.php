<?php
  ...
  //print_r($_SESSION);
  $title_1 = "Input Nilai Kelas " . $_GET['kelas'];
        ...
        <div id="container">
          <div class="columnLayout">
            ...
            */
              ...
              function raporRenderer(instance, td, row, col, prop, value, cellProperties) {
                Handsontable.renderers.TextRenderer.apply(this, arguments);
                td.style.fontWeight = 'bold';        
                td.style.background = '#CDEFFA';
                if ((value>100)||(value<kkm)) {
                    td.style.color = 'red';
                }else{
                    td.style.color      = 'black';      
                };
              ...
              */
              ...
              hot = new Handsontable(container, {
                ...
                customBorders   : [
                                    ...
                                    { range: {from: {row: 0, col: 0}, to:{row: 2, col: (c+3)}}, bottom: { width: 1,color: 'black'}},
                                    { row: 0, col: 1, bottom: { width: 1,color: 'black'}},
                                    { row: 0, col: 2, bottom: { width: 1,color: 'black'}},
                                    { row: 0, col: 5, bottom: { width: 1,color: 'black'}}
                                  ],
                ...
                cells           : function (row, col, prop) {
                                    ...
                                    if ((col >= 0)&&(col <= 5)){
                                      ...
                                      cellProperties.renderer = raporRenderer;
